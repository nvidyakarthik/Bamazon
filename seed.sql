...
("WaterWipes Sensitive Baby Wipes, 9 Packs of 60 Count (540 Count)","Baby",28.73,300),
("Bambo Nature Baby Diapers Classic, Size 4 (15-40 lbs), 180 Count (6 Packs of 30)","Baby",71.25,500),
("Polo Ralph Lauren Men's Faxon Low Sneaker","Shoes",39.95,800),
("Adidas Men's Seeley Skate Shoe","Shoes",60.22,450),
("Under Armour Boys' Boys' Leadoff Low RM Jr.","Shoes",27.99,200),
("Kstare Women Casual Long Sleeve Cotton Solid Loose Pockets T-Shirt Blouses Tops","Clothing",14.59,100),
...
("Silk18 Natural Hair Conditioner Argan Oil Sulfate Free Treatment for Dry and Damaged Hair","Personal Care",10.40,400),
